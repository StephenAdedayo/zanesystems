  ...
  return (
    <div className='px-5 md:px-16 lg:px-20 my-20 bg-slate-100 py-10'>
      ...
      <div className='flex items-center  gap-5 mb-5'>
           ...
           <p className='text-brand-navy text-lg uppercase'>The person behind it</p>  
      </div>
      ...
      <div className='flex flex-col mt-10 lg:flex-row gap-0 rounded-2xl overflow-hidden w-full'
      style={{
    ...
    >
      ...
      <div className='flex flex-col justify-between p-10 flex-[50%]'>
        ...
        {/* Quote / bio */}
        <div>
          <div className='text-brand-navy text-4xl font-ovo leading-none mb-4 opacity-40'>"</div>
          <p className='font-ovo text-brand-navy-deep text-lg leading-relaxed mb-6'>
            We built Zane Systems on one belief — that the aviation industry deserves a parts supplier that never compromises on quality or trust.
          </p>
          ...
          <p className='font-outfit text-sm text-gray leading-[1.85] opacity-80'>
            With over 20 years in aviation supply chain management, James founded Zane Systems Limited with a mission to bring world-class, fully traceable aircraft components to airlines and MRO facilities across the globe.
          </p>
        </div>
        ...
        <div className='mt-10'>
          ...
          <div className='flex flex-col tablet:flex-row gap-8 mb-8'>
            ...
            <div>
              <p className='font-ovo text-2xl text-brand-navy-deep'>20<span className='text-brand-navy'>+</span></p>
              <p className='font-outfit text-xs text-gray opacity-60 uppercase tracking-widest mt-1'>Years Experience</p>
            </div>

            <div className='w-px bg-slate-200' />

            <div>
              <p className='font-ovo text-2xl text-brand-navy-deep'>80<span className='text-brand-navy'>+</span></p>
              <p className='font-outfit text-xs text-gray opacity-60 uppercase tracking-widest mt-1'>Countries Served</p>
            </div>

            <div className='w-px bg-slate-200' />

            <div>
              <p className='font-ovo text-2xl text-brand-navy-deep'>50K<span className='text-brand-navy'>+</span></p>
              <p className='font-outfit text-xs text-gray opacity-60 uppercase tracking-widest mt-1'>Parts Supplied</p>
            </div>
